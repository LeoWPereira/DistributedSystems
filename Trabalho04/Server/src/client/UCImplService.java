 ...
 * 
 */
@WebServiceClient(name = "UCImplService", targetNamespace = "http://uc.javajeff.ca/", wsdlLocation = "http://localhost:9901/UC?wsdl")
    ...
    extends Service
{
    ...
    private final static QName UCIMPLSERVICE_QNAME = new QName("http://uc.javajeff.ca/", "UCImplService");
    ...
    public UC getUCImplPort() {
        return super.getPort(new QName("http://uc.javajeff.ca/", "UCImplPort"), UC.class);
    }
    ...
    public UC getUCImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://uc.javajeff.ca/", "UCImplPort"), UC.class, features);
    }
